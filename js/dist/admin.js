...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('ianm/boring-avatars', function () {
  //modifyCommonAvatarHelper();
  //modifyAdminAvatarHelper();

  var themeOptionsArray = Array.isArray((flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().data).boringAvatarThemes) ? (flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().data).boringAvatarThemes : [];

  // Convert the array into a key-value pair object.
  var avatarOptions = themeOptionsArray.reduce(function (obj, theme) {
    obj[theme] = theme; // Use theme as both key and value.
    return obj;
  }, {});
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('ianm-boring-avatars').registerSetting({
    setting: 'ianm-boring-avatars.theme',
    type: 'select',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('ianm-boring-avatars.admin.settings.theme'),
    help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('ianm-boring-avatars.admin.settings.theme_help'),
    options: avatarOptions
  }).registerSetting({
    setting: 'ianm-boring-avatars.include_forum_colors',
    type: 'boolean',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('ianm-boring-avatars.admin.settings.include_forum_colors'),
    help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('ianm-boring-avatars.include_forum_colors_help')
  });
});
